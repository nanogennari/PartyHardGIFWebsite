...
$htmls = array(
  "topRight" => "
      ...
      <a href='http://partyhard.online/?image=".$imageName."'>Link to this</a>
      ",
  "topLeft" => "
  ...
  "bottomLeft" => "
      ...
      <div class='fb-like' data-href='https://partyhard.online/' data-layout='box_count' data-action='like' data-show-faces='true' data-share='true'></div></br>
    	...
    	<!--Twitter Button-->
    	<a href='https://twitter.com/share' class='twitter-share-button'{count} data-url='http://partyhard.online' data-text=\"Let's PARTY HARD!!!!!!!\" data-hashtags='PartyHard'>Tweet</a>
